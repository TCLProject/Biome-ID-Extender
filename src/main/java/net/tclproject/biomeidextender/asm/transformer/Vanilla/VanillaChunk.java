...
public class VanillaChunk implements IClassNodeTransformer {
   public void transform(ClassNode cn, boolean obfuscated) {
      ...
      if (method != null) this.transformFill(cn, method, obfuscated);
      ...
      while(it.hasNext()) {
         ...
         if (insn.getOpcode() == 180 && ((FieldInsnNode)insn).name.equals(Name.chunk_blockBiomeArray.getName(obfuscated))) it.set(Name.chunk_blockBiomeArray.getField(obfuscated));
         if (insn.getOpcode() == 51) it.set(new InsnNode(53));
         if (insn.getOpcode() == 84) it.set(new InsnNode(86));
      }
      ...
      MethodNode getBiomeShortArray = new MethodNode(1, "getBiomeShortArray", "()[S", null, null);
      MethodNode setBiomeShortArray = new MethodNode(1, "setBiomeShortArray", "([S)V", null, null);
...
//                     System.out.println("----------------------***----------------------");
                  ...
                  if (Name.ebs_getBlockMSBArray.matches(node, obfuscated)) {
                     while (it.previous().getOpcode() != 162) {}
   ...
   private void fillGetBiomeShortArray(ClassNode cn, MethodNode method, boolean obfuscated) {
      ...
      LocalVariableNode var = new LocalVariableNode("this", "Lnet/minecraft/world/chunk/Chunk;", null, l0, l1, 0);
      code.add(l0);
      code.add(lnn);
      code.add(new VarInsnNode(25, 0));
   ...
   private void transformConstructor(ClassNode cn, MethodNode method, boolean obfuscated) {
      ...
      while(it.hasNext()) {
         ...
         if (insn.getOpcode() == 184 && ((MethodInsnNode)insn).desc.equals("([BB)V")) it.set(new MethodInsnNode(184, "java/util/Arrays", "fill", "([SS)V", false));
